# Repo Scope — A Binding Law

**Status:** Confirmed, binding — applies to every file in this repo, across every Tepenian Universe project it serves (InnerTepeniaGDD, TheCryptographHelixDD, OuterTepenia1_GDD, SouthernLights, CurrentNovelDocs)

**The law:** this repo exists to answer exactly three questions, and nothing beyond them:

- **When** everything happens — chronology, dates, eras, timelines, sequencing.
- **Where** everything happens — geography, locations, cities, subnets, highways, physical routes.
- **Who's** involved — characters, factions, and their backstory, relationships, and role in events.

If a piece of content doesn't serve one of those three questions, it does not belong in this repo — it belongs in whichever individual project actually needs it.
...
- Timeline eras, dates, and event sequencing shared across projects.
...
Before adding or porting content here, ask: does this tell you *when*, *where*, or *who*? If the honest answer is "it tells you *how to play/read it*" or "*what mechanically happens next*," it's out of scope — note its existence if useful for cross-reference, but don't port the content itself.
