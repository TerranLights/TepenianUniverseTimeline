...
Language is the third of the three genuinely distinct things set at a robot's fabrication, alongside
Personality (Chapter 5) and Build (Chapter 3) — never a sub-part of either, and, unlike them, a phenomenon
this book previously misread as a single, uniform, robot-wide fact before correcting course. What a robot
actually speaks turns out to be one of the clearest cases in this entire book of a fact that looks like it
should belong on the universal floor, and doesn't.

## The Language Module

Delivered at least in part through a Language Module set at build time — its exact mechanism still
undetermined — a robot's capacity for language is established at fabrication the same way Personality and
Build are. But the module sets the *capacity*, not the *content*. What a robot actually goes on to speak
day to day is not fixed by the module itself; it is determined by something entirely outside of it.
...
Example: Sumerian's Liturgical Register), Part IV.
