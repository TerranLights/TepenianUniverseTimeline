...
He and Eira went on to defend Tepenian interests together. He died before the Long Night War — possibly on assignment with Eira, possibly of old age; the circumstances are undetermined — but he would certainly have fought alongside Tepenians had he lived to see it.

She is currently missing in action; her status and current whereabouts are unknown, though presumed alive, with her last known location somewhere in South America.

## Role in Main Story / World
- Connection to larger narrative: Known to Concordia only in specific circles (primarily Pisces / The Markets) as a figure associated with robot-sovereignty enforcement in Upper Earth; currently unaccounted for.

## Canonical Appearances
- InnerTepeniaGDD — origin — [status: Off-World or MIA] (only project of appearance currently)

## Design Notes & Open Questions
- TODOs: Activation date, place of origin, exact circumstances/date of her disappearance, and the name of the human guard-turned-lover are all currently unestablished in source material.
