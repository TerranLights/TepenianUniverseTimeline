...
- Connection to larger narrative: (placeholder — beyond her standing within Scorpio's transformation community as described above)

## Canonical Appearances
- InnerTepeniaGDD — origin — [status: Still Present In-Game] (only project of appearance currently)

## Design Notes & Open Questions
- **Requires future design & development:** No backstory has been confirmed with the setting's creator yet — her placement in Scorpio was set before any real backstory was worked out. Needs a dedicated design session.
- Enneagram type (9w1, Self-Preservational subvariant) is established; activation date, place of origin, and full personality/backstory detail are not yet developed — flagged for future design work.
- Name and full identity not yet finalized in source project.
- Companion/romance mechanics (recruitability, stat/trait thresholds) are CRPG-specific to InnerTepeniaGDD and intentionally not duplicated here.
