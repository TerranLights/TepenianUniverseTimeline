...
Her ongoing struggle centers on whether she can be preserved at all: her failing systems raise the possibility of transferring her personality into another substrate, which would let her persist but carries a real risk of losing or altering her memories in the process — a question that touches directly on identity, memory, and what it means to survive at all.

## Role in Main Story / World
- Connection to larger narrative: Serves as an archive-narrator figure — she knows the history of ruined and abandoned places within her old signal range and can guide others through Concordia's past. Her personal arc, concerning her own slow deterioration and the question of whether and how she can be preserved, forms an emotional throughline about memory, identity, and sacrifice in a dying world.

## Canonical Appearances
- InnerTepeniaGDD — origin — [status: Still Present In-Game] (only project of appearance currently)

## Design Notes & Open Questions
- **⚠ URGENT — requires future design & development:** Of all the Dolls in this repo, Calethina most urgently needs a real, confirmed backstory session with the setting's creator. She currently has zero user-authored canon anywhere in her file — every other character has at least some confirmed Personal_Background content; she has none. Prioritize her above the other flagged characters below.
- **Provisional backstory, not yet confirmed:** The entire backstory above is drawn from a single questline document in the source project that is explicitly marked "DEFERRED — Review Required Before Development" and was written by Grok (an AI drafting tool), not yet reviewed or confirmed as canon by the setting's creator. It's kept here as the working direction because the general premise (degrading holographic AI, energy-grid dependency, the Ji-Eun Kim connection) reads as reasonable reference material, but treat none of it as settled until confirmed. Further detail on her degradation arc, Ji-Eun Kim's ultimate fate, and the eventual resolution of her situation remain open for future development.
