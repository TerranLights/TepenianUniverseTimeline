...
Her degradation is tied to a specific cause, confirmed 2026-07-12: the same catastrophic energy-grid mega-shock that caused the Planetary Split Brain (the setting's single largest infrastructure catastrophe) also partially corrupted her — her condition is a direct consequence of that event, not an isolated malfunction unique to her alone. Her long-term survival remains genuinely uncertain as a matter of backstory; how (or whether) that gets resolved is not itself part of this repo's scope (see Design Notes).
...
Her manufacturing and shipping origin has also been formalized as deliberately unmarked lore — discoverable background, not something openly documented in-world or delivered through any structured questline: she passed through seven locations across six subnets plus the South Pole before reaching her lab — request and design work at Mawson and the Halley subnet, engineering at Kunlun/Mirny, construction at Byrd, stress-testing near Palmer, shipping routed through Port Lockroy, a reroute personally ordered from Fort McMurdo (Tepenia's historical capital), and a final leg forward-shipped via the Amundsen-Scott Station — passing through the Tower's own site before it later caused her defining trauma.
