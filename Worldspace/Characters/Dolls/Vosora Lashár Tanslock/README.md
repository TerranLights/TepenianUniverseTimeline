...
Less visibly, she has continued working the data-recovery side of an investigation into corrupted and destroyed historical records — reconstructing what was destroyed rather than merely verifying what survived. She has gotten close enough to an answer that whoever was responsible for the destruction is now aware of her, and she has been receiving undisclosed pressure as a result.

See `Personal_Background/` for timeline and detailed records.

## Role in Main Story / World
- Connection to larger narrative: Her investigation into suppressed or destroyed historical records carries broader political weight in Concordia — the shape of what is missing from the record implies who was erased and why. She works this thread in informal parallel with Michelle Stanton, who verifies what remains rather than reconstructing what was destroyed; together their work forms a more complete inquiry than either could produce alone.

## Canonical Appearances
- InnerTepeniaGDD — origin — [status: Still Present In-Game] (only project of appearance currently)

## Design Notes & Open Questions
- TODOs: Her relationship dynamic with Michelle Stanton is undesigned beyond both working the same inquiry. She has some personal connection to a figure named Kunlun (flagged in source material, exact nature undetermined). The identity of whoever has been pressuring her over her investigation is undesigned. Full personality/voice finalization and exact activation date/place of origin remain unestablished in source material.
