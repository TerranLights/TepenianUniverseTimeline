...
- Migrated: the handful of dated district-level events in `Timeline Eras/2 The Second Interwar Period/Timeline.md`'s "Confirmed Dated Events" table, and city/character facts folded into specific Doll character files during backstory work (e.g. Zukelli/Janbogo's destruction, Fort McMurdo as historical capital, Casey's Megasheet existing — see `TODO.md`).
